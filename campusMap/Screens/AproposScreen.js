    ...
    return  (
       <ScrollView contentContainerStyle={styles.container}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.imageContainer}>
          <Image source={require('../assets/fac6.jpeg')} style={styles.img} />
          <Image source={require('../assets/fac11.jpg')} style={styles.img} />
          <Image source={require('../assets/fac5.jpg')} style={styles.img} />
